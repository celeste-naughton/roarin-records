...
//2. Open database connection before, place in secure folder
$db = init_sqlite_db('secure/site.sqlite', 'db/init.sql');

//3. Check for login HTTP Parameters or session cookies and login/logout
...
const ROUTES = array(
  ...
  '/records-form' => 'pages/records-form.php'
);
